...
public class WeatherActivity extends BaseActivity {
    ...
    BDLocationListener mBaiduListener = null;
    @Bind(R.id.mapView)
    ...
    void initLocation() {
        ...
        mLocationClient.setLocOption(prepareBaiduMapLocationClientOptions());
    ...
    @NeedsPermission({Manifest.permission.READ_PHONE_STATE,
            Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION,
            Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE})
    void initLocationRationale(PermissionRequest request) {
    ...
    private LocationClientOption prepareBaiduMapLocationClientOptions() {
