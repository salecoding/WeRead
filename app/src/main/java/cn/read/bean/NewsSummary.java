...
public class NewsSummary implements Parcelable {
    ...
    @Generated(hash = 1352790538)
    public NewsSummary(String postid, boolean hasCover, int hasHead, int replyCount, int hasImg, String digest,
            boolean hasIcon, String docid, String title, String ltitle, int order, int priority, String lmodify,
            String boardid, String photosetID, String template, int votecount, String skipID, String alias,
            String skipType, String cid, int hasAD, String source, String ename, String imgsrc, String tname,
            String ptime, boolean isFavorites) {
        this.postid = postid;
    ...
    public boolean equals(Object o) {
        ...
        NewsSummary other = (NewsSummary) o;
        if (postid.equals(other.getPostid())) {
            return true;
        }
        return false;
    }
