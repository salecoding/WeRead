...
public class NewsChannelTable {
    ...
    @Generated(hash = 1975581118)
    public NewsChannelTable(String tableId, @NotNull String newsChannelName,
            @NotNull String newsChannelId, @NotNull String newsChannelType,
            boolean newsChannelSelect, int newsChannelIndex, Boolean newsChannelFixed) {
