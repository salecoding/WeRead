...
public class ApiConstants {
     ...
     * 干货福利图片url
     */
    public static final String WELFARE_PHOTO_HOST = "http://gank.io/api/data/福利/20/";
    /**
     * 新浪图片新闻
     */
    ...
    //聚合数据id
    public final static String JUHE_CHAT_APPID = "f90425087a96d8bfca7ed8dfbd96c1a7";
    //机器聊天
    public final static String CHAT_URL = "http://op.juhe.cn/robot/index?key=" + JUHE_CHAT_APPID + "&info=";
     ...
     * @return 新闻类型
     */
    public static String getNewsType(String id) {
        switch (id) {
            case HEADLINE_ID:
     ...
     * @return
     */
    public static String getVideosType(String id) {
        return "list";
    }
